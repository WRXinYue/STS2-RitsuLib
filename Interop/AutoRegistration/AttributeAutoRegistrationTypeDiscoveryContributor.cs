                ...
                switch (attribute)
                {
                    ...
                    case RegisterCharacterStarterRelicAttribute starterRelic:
                        ...
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.ContentSecondary,
                            ...
                            () => contentRegistry.RegisterCharacterStarterRelic(starterRelic.CharacterType, type,
                                starterRelic.Count),
                            [
                    ...
                    case RegisterCharacterStarterPotionAttribute starterPotion:
                        ...
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.ContentSecondary,
                            ...
                            () => contentRegistry.RegisterCharacterStarterPotion(starterPotion.CharacterType, type,
                                starterPotion.Count),
                            [
                    ...
                    case RegisterOwnedKeywordAttribute ownedKeyword:
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.Keywords,
                            ...
                            () => keywordRegistry.RegisterOwned(
                                ValidateNonEmpty(ownedKeyword.LocalKeywordStem, nameof(ownedKeyword.LocalKeywordStem)),
                    ...
                    case UnlockEpochAfterAscensionWinAttribute unlockAfterAscensionWin:
                        ...
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.Unlocks,
                            ...
                            () => unlockRegistry.UnlockEpochAfterAscensionWin(type, unlockAfterAscensionWin.EpochType,
                                unlockAfterAscensionWin.AscensionLevel),
                            [TypeDependencyKey(type), $"RegisterEpoch:{unlockAfterAscensionWin.EpochType.FullName}"]));
                        break;
                    ...
                    case UnlockEpochAfterBossVictoriesAttribute unlockAfterBossVictories:
                        ...
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.Unlocks,
                            ...
                            () => unlockRegistry.UnlockEpochAfterBossVictories(type, unlockAfterBossVictories.EpochType,
                                unlockAfterBossVictories.RequiredBossWins),
                            [TypeDependencyKey(type), $"RegisterEpoch:{unlockAfterBossVictories.EpochType.FullName}"]));
                        break;
                    case UnlockEpochAfterAscensionOneWinAttribute unlockAfterAscensionOne:
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.Unlocks,
                            ...
                            [TypeDependencyKey(type), $"RegisterEpoch:{unlockAfterAscensionOne.EpochType.FullName}"]));
                        break;
                    ...
                    case UnlockCharacterAfterRunAsAttribute unlockCharacterAfterRun:
                        operations.Add(CreateOperation(ownerModId, type, AutoRegistrationPhase.Unlocks,
                            ...
                            () => unlockRegistry.UnlockCharacterAfterRunAs(type, unlockCharacterAfterRun.EpochType),
                            [TypeDependencyKey(type), $"RegisterEpoch:{unlockCharacterAfterRun.EpochType.FullName}"]));
                        break;
                }
